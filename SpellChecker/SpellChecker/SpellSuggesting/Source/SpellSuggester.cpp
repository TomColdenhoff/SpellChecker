...
//                    if (charIndex == remainingChars.size() - 1) {
//                        remainingString = remainingChars[remainingChars.size() - 1];
//                    }
//                    else {
//                        remainingString = remainingChars.substr(charIndex + 1, remainingChars.size());
//                    }
//
//                    std::vector newWords = FindSuggestion(trace, remainingString, currentOffset + 1, currentNode);
//
//                    if (newWords.size() > 1) {
//
//                    }
